...
## R1 - barcodeCounts:
bc.L1.R1.file <- 'results/qc/fastq/fastq_process/barcodeCounts_L1_redo_S2.R1.txt'
...
## R1 - nCounts:
nCounts.L1.R1.file <- 'results/qc/fastq/fastq_process/nCounts_L1_redo_S2.R1.txt'
...
## R2 - barcodeCounts:
bc.L1.R2.file <- 'results/qc/fastq/fastq_process/barcodeCounts_L1_redo_S2.R2.txt'
...
## R2 - nCounts:
nCounts.L1.R2.file <- 'results/qc/fastq/fastq_process/nCounts_L1_redo_S2.R2.txt'
...
## R1 - barcodeCounts:
bc.L4.file <- 'results/qc/fastq/fastq_process/barcodeCounts_newLib_failedInds.R1.txt'
...
## R1 - nCounts:
nCounts.L4.R1.file <- 'results/qc/fastq/fastq_process/nCounts_newLib_failedInds.R1.txt'
...
## R2 - barcodeCounts:
bc.L4.R2.file <- 'results/qc/fastq/fastq_process/barcodeCounts_newLib_failedInds.R2.txt'
...
## R2 - nCounts:
nCounts.L4.R2.file <- 'results/qc/fastq/fastq_process/nCounts_newLib_failedInds.R2.txt'
