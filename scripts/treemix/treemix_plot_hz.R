...
#root <-'mruf'; dir.output <- 'output/bySupersite/'; poporder <- unique(lookup$supersite); dir.fig <- 'figures/bySupersite/'
#root <-'ruf'; dir.output <- 'output/bySupersite2/'; poporder <- unique(lookup$supersite2); dir.fig <- 'figures/bySupersite2/'

file.ID <- 'hzproj2.mac1.FS6'
root <-'None'; dir.output <- 'output/bySupersite2/'; poporder <- unique(lookup$supersite2); dir.fig <- 'figures/supersite2/'
