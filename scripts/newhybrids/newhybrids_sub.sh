...
/datacommons/yoderlab/users/jelmer/scripts/newhybrids/newhybrids_pip.sh $RUN_ID $VCF $NEWHYBRIDS_INPUT $MEM
...
NSWEEPS=10000
sbatch -p yoderlab,common,scavenger --mem=12G -o slurm.newhybrids.run.$RUN_ID \
/datacommons/yoderlab/users/jelmer/scripts/newhybrids/newhybrids_run.sh $NEWHYBRIDS_INPUT $OUTDIR $BURNIN $NSWEEPS
