...
echo -e "\n## dedup.trim.sh: Starting with script."
date
echo -e "Args:\n$@\n"
...
if [ $R2 != "NONE" ] && [ $SKIP_DEDUP = "FALSE" ]; then
	echo "## dedup.trim.sh: Dedup step..."
	echo "## dedup.trim.sh: Running stacks..."
...
################################################################################
echo -e "\n#####################################################################"
echo "## dedup.trim.sh: Trimming step..."
...
echo -e "\n## dedup.trim.sh: Done with script."
date